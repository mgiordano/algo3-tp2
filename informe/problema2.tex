...
Pseudocódigo presentado en la sección 2.3.	
 \begin{enumerate}
	...
	\begin{IndentedEnumerate}		
		\item Idem, recorre las megavallas verticales
		\begin{IndentedEnumerate}
		\item .
 ...
 \indent Nuevamente, como $Java$
realiza las asignaciones por referencia, la operación de la linea 12
se hace en tiempo constante.\\
 \indent En lo que queda de la función realizamos operaciones $O(1)$ para calcular enteros y creamos la matriz
en $O(vallas^2)$.\\
 \indent El while de la linea 4 itera $vallas$ veces al igual que el de la linea
5, por lo tanto vamos a tener $O(vallas$ $*$ $vallas)$ multiplicado por el costo
del segundo while. En este while realizamos todas operaciones $O(1)$ salvo los
llamados a $entranLoBicho$ que cuestan $O(vallas)$.\\
